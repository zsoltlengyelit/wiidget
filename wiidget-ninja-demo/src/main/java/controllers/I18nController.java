...
public class I18nController {
	...
	public Result indexWithLanguage(@PathParam("language") final String language) {

		final Result result = Results.ok().html()
				.template("/views/I18nController/index.ftl.html");
