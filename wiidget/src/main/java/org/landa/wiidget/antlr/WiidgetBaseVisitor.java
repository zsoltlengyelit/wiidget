...
public class WiidgetBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements WiidgetVisitor<T> {
	...
	@Override public T visitIndexExpression(WiidgetParser.IndexExpressionContext ctx) { return visitChildren(ctx); }

	@Override public T visitIndexingExpression(WiidgetParser.IndexingExpressionContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitMathematicalOperandExpression(WiidgetParser.MathematicalOperandExpressionContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitMethodCallExpression(WiidgetParser.MethodCallExpressionContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitMathematicalOperator(WiidgetParser.MathematicalOperatorContext ctx) { return visitChildren(ctx); }
	...
	@Override public T visitMathematicalExpression(WiidgetParser.MathematicalExpressionContext ctx) { return visitChildren(ctx); }
